...
const Menu = ({ history }) => ( <
    ...
    <
    Link className = "navbar-brand hoverable"
    id = "len1"
    ...
    <
    Link className = "nav-link hoverable"
    id = "len2"
    style = { isActive(history, "/shop") }
    to = "/shop" >
    <
    i className = "fas fa-book pr-2" > < /i> <
    span className = "coll" > Shop < /span> <
    /Link> <
    /li>
...

    {
        isAuthenticated() && ( <
            ...
            <
            span className = "nav-link hoverable"
            id = "len7"
            style = {
